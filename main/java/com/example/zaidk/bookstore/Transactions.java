...
/**
 * Created by zaidkurchied on 17/03/2016.
 */
...
//    }
    protected void showList(String user) {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Transactions.this, bookList, R.layout.trans_list_item,
                    new String[]{
                            TAG_USER,
                            TAG_NAME,
                            TAG_PRICE,
    ...
    public void getCart() {
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                DefaultHttpClient httpclient = new DefaultHttpClient(new BasicHttpParams());
                HttpPost httppost = new HttpPost("http://10.0.2.2/info/showTransactions.php");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Transactions.this, AdminSide.class);
